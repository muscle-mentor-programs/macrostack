...
The retailer meal-plan editor uses the same bundled food database, custom foods and relevance ranking as the coach editor. It supports brand/name searches, servings and amount conversion, automatic macro scaling, manual foods, multiple days, day duplication and day totals. Shared custom foods remain subject to their existing RLS.
