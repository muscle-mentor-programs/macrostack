...
export default function CoachBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-20 bg-surface border-t border-border nav-safe-bottom">
      ...
      {NAV.map(({ id, label, icon: Icon }) => {
        ...
        return (
          ...
          >
            ...
            {active && (
              <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-6 h-0.5 bg-brown rounded-full" />
            )}
          </button>
        )
      })}
