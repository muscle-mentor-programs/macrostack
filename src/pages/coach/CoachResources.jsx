...
export default function CoachResources({ account = false }) {
  ...
  const items=account ? [
    ['retail','Retail workspace','Manage store customers, nutrition plans, journals and progress',Users],
