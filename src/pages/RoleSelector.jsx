  ...
  return (
    <div className="flex h-screen w-screen bg-bg items-center justify-center anim-fade-in">
      <div className="w-full max-w-2xl px-8">
        ...
        {/* Role cards — aspect-square on wrapper div guarantees equal sizes */}
        <div className="grid grid-cols-2 gap-6 anim-stagger">
          {/* Coach Portal */}
          <div className="aspect-square anim-fade-in-up">
            <button
          ...
          {/* Client App */}
          <div className="aspect-square anim-fade-in-up" style={{ animationDelay: '80ms' }}>
            <button
