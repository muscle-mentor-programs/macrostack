  ...
  return (
    <div className="software-ui software-client flex flex-col h-full w-full bg-bg relative">
      ...
      <div className="product-controls fixed top-safe right-4 z-30 flex items-center gap-2">
        ...
        <a href="/retail/member?chat=1" title="Chat with your store" aria-label="Chat with your store" className="h-9 px-3 flex items-center gap-1.5 rounded-xl bg-card border border-border text-cream"><Store size={15}/><span className="font-mono text-xs">Store chat</span></a>
        <ThemeToggle compact />
        <button
          onClick={logout}
          title="Log out"
