...
const hook=readFileSync('src/hooks/useSubscription.js','utf8').replace("import useClock from '../retail/useClock'", "const useClock=()=>Date.now()").replace("import useStore from '../store'",'').replace('export default function','function')
