...
const high = task('high', { due: today, priority: 'high', owner: `Client ${String.fromCharCode(8212)} coach tracked` })
...
assert.equal(taskMatches(high, 'today', `Client ${String.fromCharCode(8212)} coach tracked`, '', today), true)
assert.equal(taskMatches(normal, 'today', `Client ${String.fromCharCode(8212)} coach tracked`, '', today), false)
